...
export default function TermsAndCondition() {
  return (
    <div className="terms-of-service">
                                                    <p>These terms of service outline the rules and regulations for the use of CourierBote's Website.</p>

                                                    <p>By accessing this website we assume you accept these terms of service in full. Do not continue to use CourierBote's website if you do not accept all of the terms of service stated on this page.</p>
                                                    ...
                                                    <h2>Cookies</h2>
                                                    <p>We employ the use of cookies. By using CourierBote's website you consent to the use of cookies in accordance with CourierBote's privacy policy.</p>
                                                    ...
                                                    <h2>License</h2>
                                                    <p>Unless otherwise stated, CourierBote and/or it's licensors own the intellectual property rights for all material on CourierBote. All intellectual property rights are reserved. You may view and/or print pages from www.courierbote.com/ for your own personal use subject to restrictions set in these terms of service.</p>

                                                    <p>You must not:</p>
                                                    <ul>
                                                        <li>Republish material from www.courierbote.com/</li>
                                                        <li>Sell, rent or sub-license material from www.courierbote.com/</li>
                                                        <li>Reproduce, duplicate or copy material from www.courierbote.com/</li>
                                                        <li>Redistribute content from CourierBote (unless content is specifically made for redistribution).</li>
                                                    </ul>

                                                    {/* User Comments */}
                                                    <h2>User Comments</h2>
                                                    <p>This Agreement shall begin on the date hereof.</p>
                                                    <p>Certain parts of this website offer the opportunity for users to post and exchange opinions, information, material and data ('Comments') in areas of the website. CourierBote does not screen, edit, publish or review Comments prior to their appearance on the website and Comments do not reflect the views or opinions of CourierBote, its agents or affiliates. Comments reflect the view and opinion of the person who posts such view or opinion. To the extent permitted by applicable laws CourierBote shall not be responsible or liable for the Comments or for any loss cost, liability, damages or expenses caused and or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website. CourierBote reserves the right to monitor all Comments and to remove any Comments which it considers in its absolute discretion to be inappropriate, offensive or otherwise in breach of these Terms of Service.</p>
                                                    {/* End of omitted content */}
                                                    {/* Other sections omitted for brevity */}
                                                    {/* User Comments (continued) */}
                                                    ...
                                                    <p>You hereby grant to CourierBote a non-exclusive royalty-free license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</p>
                                                    ...
                                                    <p>No use of CourierBote's logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
